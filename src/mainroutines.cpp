...
const  double deg2rd = 0.017453292519943295769236907684886;
const  double rd2deg = 57.295779513082320876798154814105;
const  double heure2rd = 0.26179938779914943653855361527329;
const  double rd2heure = 3.8197186342054880584532103209403;
const  double SolarSiderealCorrection = 1.002738;

//---------------------------------------------------------------------------
	//ChangeVille();
	// 0x00055278, 348792 , 0xffffcc9f, -13153  		// { 1, "Tlemcen        ", 34.879200 , -1.315300  },
	const char CountryName[]  = "Algérie";
	const char TownName[]  = "Tlemcen";
	...
	const char day_0[]  = "Lundi";
	const char day_1[]  = "Mardi";
	const char day_2[]  = "Mercredi";
	const char day_3[]  = "Jeudi";
	const char day_4[]  = "Vendredi";
	const char day_5[]  = "Samedi";
	const char day_6[]  = "Dimanche";
	const char* const Days[]  = {day_0, day_1, day_2, day_3, day_4, day_5};
...
// debug
  date.a = timeinfo.tm_year + 1900;
  date.m = timeinfo.tm_mon + 1;
  date.j = timeinfo.tm_mday;
	#ifdef Verbose
...
void GetHeure()
{
  heure.h = timeinfo.tm_hour;
  heure.m = timeinfo.tm_min;
  heure.s = timeinfo.tm_sec;
	heure.ms=0;
